...
def index():
    if request.method == 'GET':
        ...
        print("Yellow Button Value is %s" %request.form['yellow'])
        ...
        if request.form['yellow'] == "ON":
            return render_template("index.html", button2value="OFF", title=title)
        elif request.form['yellow'] == "OFF":
            return render_template("index.html", button2value="ON", title=title)
