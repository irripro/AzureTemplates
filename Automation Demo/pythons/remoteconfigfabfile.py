...
def deploy():
    ...
    run("curl -O -u 6cf42ddf51af667948a026790b8139233e1a9192 x-oauth-basic https://raw.githubusercontent.com/alihhussain/ops/master/oss/TestWebPage/testweb.zip")
